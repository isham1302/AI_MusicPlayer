...
public class Main extends AppCompatActivity {
    ...
    public ArrayList<File> readOnlyAudioSongs(File file)
    {
        ...
        //Toast.makeText(this, "result"+ Arrays.toString(allFiles),Toast.LENGTH_SHORT).show();
    ...
    private void displayAudioSongsName()
    {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Main.this, android.R.layout.simple_list_item_1, itemsAll);
